...
public class ArrayListTest {
    ...
    @Test
    public void testEqualsConDiferentesClase() {
        ArrayList<Integer> list = new ArrayList<>();
        list.add(1);
        list.add(2);
        list.add(3);
        assertFalse(list.equals("No es ArrayList"));
    }

    @Test
    public void testEqualsConDiferentesContenidos() {
    ...
    @Test
    public void testEqualsConIguelContenido() {
        ArrayList<Integer> list1 = new ArrayList<>();
        list1.add(1);
        list1.add(2);
        list1.add(3);
